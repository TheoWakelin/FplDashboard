...
namespace FplDashboard.Migrations.Migrations
{
    ...
    [Migration("20250915201745_AddFixtureData")]
    partial class AddFixtureData
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FplDashboard.DataModel.Models.Fixture", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FplDashboard.DataModel.Models.Fixture", b =>
                {
                    ...
                    b.HasOne("FplDashboard.DataModel.Models.Team", "TeamA")
                        .WithMany()
                        .HasForeignKey("TeamAId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("FplDashboard.DataModel.Models.Team", "TeamH")
                        .WithMany()
                        .HasForeignKey("TeamHId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("FplDashboard.DataModel.Models.Team", null)
